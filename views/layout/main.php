<main>
    ...
    <?php elseif (isset($_SESSION['usuario'])) : ?>
        ...
        <div class="enlaces">
            <a href="<?= base_url ?>movimiento/cinco">Mostrar los últimos 5 movimientos</a>
            <a href="<?= base_url ?>movimiento/muestraTodos">Mostrar todos los movimientos</a>
            <a href="<?= base_url ?>movimiento/creaMovimiento">Nuevo movimiento</a>
